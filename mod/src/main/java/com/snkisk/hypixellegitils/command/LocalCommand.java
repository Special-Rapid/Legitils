...
public final class LocalCommand {
    ...
    private static final String[] HELP_LINES = new String[] {
        ...
        ChatFormat.continuation("§7Tab team members always stay together locally"),
        ChatFormat.continuation("§b.l stats teamsort on/off §8— §frank team blocks by FKDR + Nick 5"),
        ChatFormat.continuation("§b.l stats playersort on/off §8— §frank players inside each team"),
        ChatFormat.continuation("§b.l stats autowho on/off §8— §frefresh Stats after game start"),
        ...
        ChatFormat.continuation("§b.l stats <player> §8— §ftest providers; show current-mode WS when visible"),
    ...
    public enum StatsOption {
        ...
        static StatsOption forCommand(String value) {
            ...
            if ("autowho".equals(value) || "auto-who".equals(value)) return AUTO_WHO;
            return null;
        }
    }
